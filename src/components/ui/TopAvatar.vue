<template>
    <div class="contributor top-contributor" :id="contributor.login">
        <div class="avatar">
        ...
        <div class="details">
            ...
            <div class="info"><a :href="contributorGitHubLink">{{ contributor.login }}</a></div>
            <div class="links">
