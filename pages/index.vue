      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-4">
            ...
            <div class="white-text">
              Follow our guide to discover the best practices and procedure to
          ...
          <div class="col-4">
            ...
            <div class="white-text">
              Check the latest additions and the more significant improvements
              of the 1.7 version, the next major version of PrestaShop.
            </div>
            <a
